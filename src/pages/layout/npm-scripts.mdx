---
title: npm scripts
description: Overview of scripts used to run and build sites using the Particle Gatsby theme
---

<PageDescription>

Site's built with the Particle Gatsby theme starter come ready to go with some helpful npm scripts. You can run these commands by typing `yarn [command]` or `npm run [command]`
