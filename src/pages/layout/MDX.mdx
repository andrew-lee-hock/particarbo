...
When using quotes in custom components, content authors should manually use ["smart quotes"](https://www.figma.com/design-systems/) to adhere to the Example Content content guidelines.
